...
import CostCenterBudgetsView from '../home/cost-centers/budgets/views/CostCenterBudgetsView.vue'
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/cost-centers/:costCenterId/budgets',
          name: 'costCenterBudgets',
          component: CostCenterBudgetsView,
          props: true
        }
      ]
    }
